...
function add1(id) {
    ...
    innertxt1.innerHTML = `<span class="itemindiv" id="span_${Date.now()}">${addWork[addWork.length - 1].work1}</span>
    <button class="markbtn" onclick="markasdone('span_${Date.now()}',this)">Mark Completed</button>`
